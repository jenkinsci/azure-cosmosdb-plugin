...
public class ConfigurationAsCodeTest {
  ...
  public void importConfig() {
    ...
    AzureCosmosDBKeyCredentials azureCosmosDBKeyCredentials =
    ...
    AzureCosmosDBCredentials azureCosmosDBCredentials =
        (AzureCosmosDBCredentials) cosmosDbCredentials;
    ...
    assertThat(
        azureCosmosDBCredentials.getUrl(),
        equalTo("https://your-account-name.documents.azure.com:443/"));
  }
  ...
  private static Mapping getCredentialsRoot(ConfigurationContext context) throws Exception {
    ...
    return Objects.requireNonNull(
            unclassifiedConfigurator.describe(

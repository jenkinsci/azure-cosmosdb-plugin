...
public class AzureCosmosDBCacheTest {
  ...
  public void toStringAsExpected() {
    ...
    CacheKey cacheKey =
        new CacheKey(credentials, "https://your-account-name.documents.azure.com:443/", "UK South");
  ...
  public void equalsMatchesForImdsCredentials() {
    String url = "https://your-account-name.documents.azure.com:443/";
    AzureImdsCredentials imdsCredentials =
        new AzureImdsCredentials(CredentialsScope.GLOBAL, "id", null);
  ...
  public void equalsDoesNotMatchesForDifferentTenantSpCredentials() {
    ...
    AzureCredentials sp =
        new AzureCredentials(
            CredentialsScope.GLOBAL, "sp", null, "1234", "12345", Secret.fromString("1234"));
    sp.setTenant("123456");
  ...
  public void equalsDoesNotMatchWhenDifferentIds() {
    ...
    AzureImdsCredentials imdsCredentials =
        new AzureImdsCredentials(CredentialsScope.GLOBAL, "id", null);
    AzureImdsCredentials imdsCredentials2 =
        new AzureImdsCredentials(CredentialsScope.GLOBAL, "id2", null);
    CacheKey imds1 = new CacheKey(imdsCredentials, url, "UK South");
